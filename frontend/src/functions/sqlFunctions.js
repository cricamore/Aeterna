...
async function obtenerProgreso(componente,email) {
    ...
    try {
      const response = await fetch(`https://aeterna-production.up.railway.app/api/obtenerprogreso`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async function guardarProgreso(componente,email,progreso) {
    ...
    try {
      const response = await fetch(`https://aeterna-production.up.railway.app/api/guardarprogreso`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async function obtenerNombre(email) {
    console.log("guardar",email)
    try {
      const response = await fetch(`https://aeterna-production.up.railway.app/api/obtenernombre`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
