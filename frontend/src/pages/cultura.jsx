...
//     obtenerProgreso()
//       .then((data) => {
//         setLeccion1Completada(data.progreso[0]);
//       })
//       .catch((error) => {
...
//     const progreso = Array.from({ length: leccionIndex + 1 }, (_, index) =>
//       index === leccionIndex ? true : leccion1Completada[index]
//     );

//     setLeccion1Completada(progreso);
