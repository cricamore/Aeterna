  ...
  return (
    ...
    >
      ...
      <div style={{margin:'auto',height:'60%',width:'60%'}}>
        ...
        <Accordion sx={{backgroundColor: 'rgba(19, 25, 47, 0.95)' }}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography sx={{fontSize:'20px', fontWeight: 'bold', color:'#E6B824' }}>¿Qué es Aeterna?</Typography>
            </AccordionSummary>
            <AccordionDetails>
        ...
        <Accordion sx={{backgroundColor: 'rgba(19, 25, 47, 0.95)'}}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography sx={{fontSize:'20px',  fontWeight: 'bold', color:'#E6B824' }}>¿Dónde puedo visualizar mi progreso?</Typography>
            </AccordionSummary>
            <AccordionDetails>
            <Typography sx={{fontWeight:'bold',color:'white'}}>
        ...
        <Accordion sx={{backgroundColor: 'rgba(19, 25, 47, 0.95)'}}>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            <Typography sx={{fontSize:'20px',  fontWeight: 'bold', color:'#E6B824' }}>¿Cómo puedo realizar las lecciones?</Typography>
            </AccordionSummary>
            <AccordionDetails>
            <Typography sx={{fontWeight:'bold',color:'white'}}>
