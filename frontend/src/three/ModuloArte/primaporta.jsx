...
export function Primaporta({leccionesCompletadas, setLeccionesCompletadas},props) {
  const { nodes, materials } = useGLTF("/static/primaporta.glb");
...
useGLTF.preload("/static/primaporta.glb");
